...
class SurrogateFactory:
    def __init__(self, box, cosmo, ngal, bg, randcat, rweights=1.0, fnl=0, fsurr=1, ksz=False, bv=None, kernel='cubic'):
        """
        ...
        self.nsurr = int(fsurr * self.nrand)
        self.fnl = fnl
        self.ksz = ksz
        ...
        self.photometric = photo
        self.rcat_ztrue = randcat.ztrue if photo else randcat.z
        self.rcat_zobs = randcat.zobs if photo else randcat.z
        self.rcat_xyz_true = randcat.get_xyz(cosmo,zcol_name=('ztrue' if photo else 'z'))
        self.rcat_xyz_obs = randcat.get_xyz(cosmo,zcol_name='zobs') if photo else self.rcat_xyz_true
        ...
        if callable(bg):
            rcat_bg = bg(self.rcat_ztrue)    # Note ztrue here
        ...
        self.rcat_bD = rcat_bg * cosmo.D(z=self.rcat_ztrue, z0norm=True)   # Note ztrue here
